...
@trojanz.on_message(filters.command('unlimitedstart') & filters.private)
...
@trojanz.on_message(filters.command('unlimitedhelp') & filters.private)
    ...
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton("BOT Channel", url="https://t.me/CinemaHaunter"),
                    InlineKeyboardButton("Support Group", url="https://t.me/Cinema_Haunter")
                ]
            ]
        ),
        reply_to_message_id=message.message_id
...
@trojanz.on_message(filters.command('unlimitedabout') & filters.private)
